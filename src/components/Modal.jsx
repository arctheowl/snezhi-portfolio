          ...
          <Dialog as="div" className="relative z-10" onClose={setOpen}>
            ...
            <div className="fixed inset-0 z-10 overflow-y-auto">
              <div className="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
                ...
                >
                  <Dialog.Panel className="relative mx-24 transform items-center rounded-lg bg-white text-left shadow-xl transition-all sm:my-2 sm:p-2">
                    <button
                      type="button"
                    ...
                    <Image src={image} alt={title} className="max-h-4xl max-w-4xl" />
                  </Dialog.Panel>
                </Transition.Child>
              </div>
            </div>
